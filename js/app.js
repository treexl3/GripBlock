 ...
 */
            !function(t, e) {
                ...
                function e() {
                    ...
                    var o = Array(t), n = 0;
                    for (e = 0; e < r; e++) for (var i = arguments[e], s = 0, a = i.length; s < a; s++, 
                    n++) o[n] = i[s];
                    return o;
                }
                var r = {
                ...
                function i(t) {
                    var e = t.pinterestText, r = encodeURIComponent(t.src);
                ...
                return function() {
                    function a(e) {
                        return this.shareOptions = [], this.core = e, this.settings = t(t({}, r), this.core.settings), 
                        this;
                    }
                    return a.prototype.init = function() {
                        this.settings.share && (this.shareOptions = e(this.getDefaultShareOptions(), this.settings.additionalShareOptions), 
                        this.setLgShareMarkup(), this.core.outer.find(".lg-share .lg-dropdown").append(this.getShareListHtml()), 
                        ...
                        this.core.outer.append('<div class="lg-dropdown-overlay"></div>'), this.core.outer.find(".lg-share").first().on("click.lg", (function() {
                        ...
                        var e = this, r = t.detail.index, o = this.core.galleryItems[r];
                        setTimeout((function() {
                        ...
                        this.core.outer.find(".lg-dropdown-overlay").remove(), this.core.outer.find(".lg-share").remove(), 
                        this.core.LGel.off(".lg.share"), this.core.LGel.off(".share");
                    }, a;
                }();
            }));
        },
 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".gallery__body")) new core(".gallery__body", {
                modules: [ Navigation, Parallax, Grid ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                slideVisibleClass: "swiper-slide-visible",
                ...
                watchOverflow: true,
                navigation: {
                    prevEl: ".gallery-arrows__arrow_prev",
                    nextEl: ".gallery-arrows__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".feedback__body")) new core(".feedback__body", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
...
***************************************************************************** */
        ...
        var lg_share_min = __webpack_require__(102);
            ...
            galleries.forEach((gallery => {
                galleyItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_thumbnail_min, lg_autoplay_min, lg_fullscreen_min, lg_share_min ],
